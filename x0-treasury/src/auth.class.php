...
class jkusdatr_auth Extends JKUSDATREASURY
{
 ...
 private function __get_group($gid)
 {
	$groups = array
	(
		0=>"Treasury",
 ...
 private function __modifyuser()
 {
	...
	{
		case 0:
			$ret = file_get_contents("ui\admin_modify.php");
				//can drop, sign up new, promote or alter new.
			break;
		case 1:
			$ret = file_get_contents("ui\deaconry_modify.php");
			//can only alter self
			break;
		default:
			$ret = file_get_contents("ui\guest_modify.php");
			//cannot do a thing
			break;
	}
	$this->result = $ret;
 ...
 private function __modifyforms()
 {
	...
	{
		case "signup":
			$ret = file_get_contents("ui\modifyforms\modifysignup.php");
			break;
		case "alterself":
			$ret = file_get_contents("ui\modifyforms\alterself.php");
			break;
		case "modifyedit":
			$ret = file_get_contents("ui\modifyforms\modifyedit.php");
			break;	
		default:
			;
	}
